...
@FacesConverter(value = "tipoIdentificacionConverter")
public class TipoIdentificacionConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TipoIdentificacion) {
            ...
            return getStringKey(o.getCodTipoIdentificacion());
        } else {
    ...
    private TipoIdentificacionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TipoIdentificacionFacade.class).get();
