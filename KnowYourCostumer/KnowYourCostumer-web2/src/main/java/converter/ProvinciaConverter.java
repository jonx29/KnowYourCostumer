...
public class ProvinciaConverter implements Converter {
    ...
    private ProvinciaFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Provincia) {
            ...
            return getStringKey(o.getCodProvincia());
        } else {
    ...
    private ProvinciaFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(ProvinciaFacade.class).get();
