...
@FacesConverter(value = "tipoIngresoConverter")
public class TipoIngresoConverter implements Converter {

    private TipoIngresoFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TipoIngreso) {
            ...
            return getStringKey(o.getCodTipoIngreso());
        } else {
    ...
    private TipoIngresoFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TipoIngresoFacade.class).get();
